...
namespace  DoYourTasks.UserControls
{
	public class MaterialMenuStrip : MenuStrip, IMaterialControl
	{
		...
		protected override void OnCreateControl()
		{
			...
			Font = new Font(FontFamily.GenericSansSerif, 10);//SkinManager.ROBOTO_MEDIUM_10;
			BackColor = SkinManager.GetPrimaryTextColor();//.PrimaryColor;
		}
	}
	...
	internal class MaterialMenuStripRender : ToolStripProfessionalRenderer, IMaterialControl
	{
		...
		protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
		{
			...
			if (e.Item.IsOnDropDown)
			{
				...
				g.DrawString(e.Text, new Font(FontFamily.GenericSansSerif, 10), e.Item.Enabled ? SkinManager.GetPrimaryTextBrush() : SkinManager.GetDisabledOrHintBrush(), textRect, new StringFormat() { LineAlignment = StringAlignment.Center });
			}
			else
			{
				g.DrawString(e.Text, new Font(FontFamily.GenericSansSerif, 10), Brushes.White, e.TextRectangle, new StringFormat() { LineAlignment = StringAlignment.Center });
			}
		}
		...
		protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
		{
			...
			if (toolStrip != null)
			{
				...
				var animationSource = toolStrip.AnimationManager;
				//if (toolStrip.AnimationManager.IsAnimating() && e.Item.Bounds.Contains(animationSource.GetDirection()))
				//{
