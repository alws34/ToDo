...
namespace  DoYourTasks.UserControls
{
    public class MaterialRadioButton : RadioButton, IMaterialControl
    {
        ...
        {
            var width = _boxOffset + 20 + (int)CreateGraphics().MeasureString(Text, new Font(FontFamily.GenericSansSerif, 10)).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            SizeF stringSize = g.MeasureString(Text, new Font(FontFamily.GenericSansSerif, 10));
            g.DrawString(Text, new Font(FontFamily.GenericSansSerif, 10), Enabled ? SkinManager.GetPrimaryTextBrush() : SkinManager.GetDisabledOrHintBrush(), _boxOffset + 22, Height / 2 - stringSize.Height / 2);
