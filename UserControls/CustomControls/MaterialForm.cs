...
namespace  DoYourTasks.UserControls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Form title
            g.DrawString(Text, new Font(FontFamily.GenericSansSerif, 12), SkinManager.ColorScheme.TextBrush, new Rectangle(SkinManager.FORM_PADDING, STATUS_BAR_HEIGHT, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
    }
